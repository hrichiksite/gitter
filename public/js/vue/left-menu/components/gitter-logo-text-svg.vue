...
<template>
  ...
  >
    <g>
      <path d="M20.9,0.3h2.6v15.8h-2.6V0.3z" />
      <path d="M34.8,2.9h-4V0.3h11.8v2.6h-5.2v13.2h-2.6V2.9z" />
      <path d="M51.9,2.9h-4V0.3h11.8v2.6h-5.2v13.2h-2.6V2.9z" />
      <path d="M66.4,0.3h11.8v2.6H69v3.9h7.9v2.6H69v4h9.2v2.6H66.4V0.3z" />
      <path
