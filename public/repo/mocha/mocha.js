  ...
  (function() {
      ...
      var JsDiff = (function() {
        ...
        return {
          ...
          createPatch: function(fileName, oldStr, newStr, oldHeader, newHeader) {
            ...
            ret.push('===================================================================');
            ret.push(
              '--- ' + fileName + (typeof oldHeader === 'undefined' ? '' : '\t' + oldHeader)
            );
            ret.push(
              '+++ ' + fileName + (typeof newHeader === 'undefined' ? '' : '\t' + newHeader)
            );
    ...
    require.register('reporters/base.js', function(module, exports, require) {
      ...
      Base.prototype.epilogue = function() {
        ...
        // pass
        fmt =
          color('bright pass', ' ') + color('green', ' %d %s complete') + color('light', ' (%s)');
    ...
    require.register('reporters/teamcity.js', function(module, exports, require) {
      ...
      function Teamcity(runner) {
        ...
        runner.on('pending', function(test) {
          console.log(
            "##teamcity[testIgnored name='" + escape(test.fullTitle()) + "' message='pending']"
          );
        });
        ...
        runner.on('end', function() {
          console.log(
            "##teamcity[testSuiteFinished name='mocha.suite' duration='" + stats.duration + "']"
          );
        });
      }
