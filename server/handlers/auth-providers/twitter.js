...
routes.login = [
  identifyRoute('login-twitter'),
  trackLoginForProvider('twitter'),
  passport.authorize('twitter', { failWithError: true })
];

routes.callback = [
  identifyRoute('login-callback'),
  passportCallbackForStrategy('twitter', { failWithError: true }),
  ensureLoggedIn,
